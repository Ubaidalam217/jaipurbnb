...
<nav class="jb-nav" aria-label="Primary">
    <div class="jb-nav__inner">
        <a class="jb-nav__brand" href="{{ url('/') }}"><img src="{{ asset('img/jaipurbnb-logo.svg') }}" alt="JaipurBnB" style="height: 65px; width: auto; background: transparent;" class="navbar-logo"></a>
    ...
    <div class="offcanvas offcanvas-end jb-offcanvas"
        ...
        <div class="jb-offcanvas__header">
            <a class="jb-offcanvas__brand" id="jbMobileNavLabel" href="{{ url('/') }}"><img src="{{ asset('img/jaipurbnb-logo.svg') }}" alt="JaipurBnB" style="height: 65px; width: auto; background: transparent;" class="navbar-logo"></a>
