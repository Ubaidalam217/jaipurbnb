...
@section('content')
    ...
    <div class="row align-items-center">
      ...
      <div class="hero-header header-heading3">
        ...
        <form action="#" data-aos="fade-left" data-aos-duration="1000">
          @csrf
        <input type="text" placeholder="Find Homes" />
  ...
  <div class="property5-section-area sp6">
    <div class="img1">
    <img src="/img/all-images/property/property-img6.png" alt="" data-aos="zoom-in-up" data-aos-duration="1000" />
    </div>
    <div class="img2">
    <img src="/img/all-images/property/property-img7.png" alt="" data-aos="zoom-in-up" data-aos-duration="1100" />
    </div>
    <div class="container">
    <div class="row">
  ...
  <!-- ===== SERVICE AREA STARTS ======= -->
  <div class="service5-section-area sp6">
    <div class="side-img">
  ...
  <!-- ===== GALLERY AREA STARTS ======= -->
  <div class="gallery5-section-area sp6">
    <div class="container">
    <div class="row">
  ...
  <div class="testimonial5-area sp6">
    <div class="container">
    <div class="row">
  ...
  <!-- ===== BLOG AREA STARTS ======= -->
  <div class="blog5-section-area sp7">
    <div class="container">
    <div class="row">
      <div class="col-lg-5 m-auto">
